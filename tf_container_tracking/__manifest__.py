# -*- coding: utf-8 -*-
{
    ...
    "author": "E4C",
    "license": "LGPL-3",
    "depends": ["tf_serial_quote_attributes", "sale_stock", "sale_management", "stock", "account", "mail"],
    "data": [
        ...
        "views/container_bulk_update_views.xml",
        "views/container_dashboard_views.xml",
        "views/dispatch_views.xml",
    ],
    "assets": {
        "web.assets_backend": [
            "tf_container_tracking/static/src/css/sale_serial_wizard.css",
            ...
            "tf_container_tracking/static/src/js/copy_to_clipboard_action.js",
